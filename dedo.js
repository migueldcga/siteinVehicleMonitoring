...
function readSpeedData(data) {
    ...
    createChartSpeed(allSpeeds);
}

function createChartSpeed(speeds) {
    console.log(speeds)
    const labels = [];
    ...
    const ctx = document.getElementById("graphSpeed");
...
function initMap() {
    ...
    // Add some markers to the map.\maps\documentation\javascript\localization
...
$("#btnImportPositions").change(function() {
